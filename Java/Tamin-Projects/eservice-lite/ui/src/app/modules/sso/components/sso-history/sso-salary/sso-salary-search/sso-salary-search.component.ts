...
@Component({
  selector: 'app-sso-salary-search',
  templateUrl: './sso-salary-search.component.html',
  styleUrls: ['./sso-salary-search.component.css']
})
export class SsoSalarySearchComponent extends TaminPageBaseComponent {
