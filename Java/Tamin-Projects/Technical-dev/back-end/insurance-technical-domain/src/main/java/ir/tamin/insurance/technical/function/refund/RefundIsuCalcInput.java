 ...
 * @author a_khalighi
 */
public class RefundIsuCalcInput implements DBFunctionInput {
    ...
    public RefundIsuCalcInput() {
    }

    public RefundIsuCalcInput(String p_cws_dbtno, String p_ref_sdate, String p_ref_edate, String p_selftype, String p_spcrate, String p_reason_code) {
