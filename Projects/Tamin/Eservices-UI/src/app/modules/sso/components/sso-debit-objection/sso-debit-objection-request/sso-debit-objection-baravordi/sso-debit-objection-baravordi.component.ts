...
@Component({
  selector: 'app-sso-debit-objection-baravordi',
  templateUrl: './sso-debit-objection-baravordi.component.html',
  styleUrls: ['./sso-debit-objection-baravordi.component.css']
})
export class SsoDebitObjectionBaravordiComponent extends TaminPageBaseComponent {
  theForm: FormGroup;
