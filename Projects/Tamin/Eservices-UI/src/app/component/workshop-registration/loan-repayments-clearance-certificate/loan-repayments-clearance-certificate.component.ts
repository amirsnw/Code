...
@Component({
  selector: 'app-loan-repayments-clearance-certificate',
  templateUrl: './loan-repayments-clearance-certificate.component.html',
  styleUrls: ['./loan-repayments-clearance-certificate.component.css']
})
export class LoanRepaymentsClearanceCertificateComponent  extends TaminPageBaseComponent {

  @ViewChild('workshopGrid') workshoptGrid: TaminDataGridComponent;
  @ViewChild('LoanRepaymentsGrid') LoanRepaymentsGrid: TaminDataGridComponent;
  ...
  initializePage() {
    ...
    this._initializeLoanRepaymentsHeadGrid();
  }
  ...
  private _initializeLoanRepaymentsHeadGrid() {
    this.LoanRepaymentsGrid.configuration = (new TaminDataGridConfigurationFactory())
      .clearActionColumns()
      .clearSearchParams()
      .clearSortParams()
      .clearVisibleColumns()
  ...
  clickWorkshopGridItem(param: any) {
    ...
    const url = Urls.clearanceCertificateLoanRepayments + '/' + workshopId + '/' + branchCode;
    this.LoanRepaymentsGrid.serviceUrl = url;
    this.LoanRepaymentsGrid.pagerCurrentPage = 1;
    this.LoanRepaymentsGrid.searchParams = this.searchParams;
    this.LoanRepaymentsGrid.refreshData();
  }

  onLoanRepaymentsGridAction(param: any) {
    var me = this
