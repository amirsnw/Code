...
@Component({
  selector: 'app-medical-committee-search',
  templateUrl: './medical-committee-search.component.html',
  styleUrls: ['./medical-committee-search.component.css']
})
export class MedicalCommitteeSearchComponent extends TaminPageBaseComponent {
