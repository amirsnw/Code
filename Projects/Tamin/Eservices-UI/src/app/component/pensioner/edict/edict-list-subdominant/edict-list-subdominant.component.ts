...
import {EdictPaymentViewComponent} from '../../edict-payment/edict-payment-view/edict-payment-view.component';
import {Urls} from '../../../../settings/urls';

declare let NumToPersian: any;

@Component({
  selector: 'app-edict-list-subdominant',
  templateUrl: './edict-list-subdominant.component.html',
  styleUrls: ['./edict-list-subdominant.component.css']
})
export class EdictListSubdominantComponent extends TaminPageBaseComponent {
  ...
  refreshData() {
    ...
    startDate.value = this.year + (this.monthNumber !== null && this.monthNumber !== ''  && this.monthNumber !== undefined ? this.monthNumber + '01' : '0101');
    ...
    this.restService
      .getAll(Urls.PensionerHokmRequest, searchParams)
      .then(result => {
