...
import {StpRequestViewComponent} from '../../../stp/requests/stp-request-view/stp-request-view.component';

@Component({
  selector: 'app-stp-requests',
  templateUrl: './stp-requests.component.html',
  styleUrls: ['./stp-requests.component.css']
})
export class StpRequestsComponent extends TaminPageBaseComponent {
  theForm: FormGroup;
  ...
  private _initializeDataGrid() {
    this.dataGrid.configuration = (new TaminDataGridConfigurationFactory())
      ...
      .clearSortParams()
      .clearVisibleColumns()
      .addUrl(StpUrls.STP_All_Request_Report)
      .setShowPager(true)
      .setFirstLoad(true)
