...
@Component({
  selector: 'app-fraction-check-istrue-contract',
  templateUrl: './fraction-check-istrue-contract.component.html',
  styleUrls: ['./fraction-check-istrue-contract.component.css']
})

export class FractionCheckIstrueContractComponent extends TaminPageBaseComponent {
