Ext.define('IncomeBank.tamin.form.field.PDate', {
    ...
    safeParse: function (value, format) {
        var me = this,
             utilDate = IncomeBank.tamin.PDate,
            //parsedDate,
            result = null,
            strict = me.useStrict,
            parsedDate;
    ...
    formatDate: function (date) {
        return Ext.isDate(date) ? IncomeBank.tamin.PDate.dateFormat(date, this.format) : date;
    },
    createPicker: function () {
        var me = this,
            format = Ext.String.format;

        return new IncomeBank.tamin.picker.PDate({
            pickerField: me,
            floating: true,
            focusable: false,
            hidden: true,
