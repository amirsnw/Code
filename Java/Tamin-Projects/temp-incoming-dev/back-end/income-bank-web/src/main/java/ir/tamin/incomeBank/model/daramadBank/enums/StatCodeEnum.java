 ...
 * @author f_fotuhi
 */
public enum StatCodeEnum {

    BARG_PASS_NASHODE("برگه های پاس نشده", "1"),
    BATEL("باطل شده", "2"),
    VOSOLI_BARAYE_VAHEDHA("وصولی برای واحد ها", "3"),
    ELAMIE_RESIDE("اعلامیه های رسیده", "4"),
    BARGASHTI("برگشتی", "5"),
    BARG_PASS_SHODE("برگه های پاس شده", "6");

    private String code;
    private String name;
    private String codeName;

    private StatCodeEnum(String name, String code) {
