...
@Component({
  selector: 'app-workshop-insurance-procrastination-new',
  templateUrl: './workshop-insurance-procrastination-new.component.html',
  styleUrls: ['./workshop-insurance-procrastination-new.component.css']
})
export class WorkshopInsuranceProcrastinationNewComponent extends TaminPageBaseComponent {
  ...
  saveForm(values) {
    ...
    this.showQuestionBox('پیام سیستم', message, () => {
      this.overlay = this.showOverlay();
      this.restService
        .create(`${Urls.insuranceProcrestination}`, jsonValue)
        .then(value => {
          this.hideOverlay(this.overlay);
          this.submitt.emit();
          this.hide();
  ...
  EditForm(values) {
    ...
    this.showQuestionBox('پیام سیستم', message, () => {
      this.overlay = this.showOverlay();
      this.restService
        .update(`${Urls.udpateInsuranceProcrestination}`, mastcustcrisisId.toString(), jsonValue)
        .then(value => {
          this.hideOverlay(this.overlay);
          this.submitt.emit();
          this.hide();
  ...
  isApprovehide(values) {
    ...
    this.overlay = this.showOverlay();
    this.restService
      .update(`${Urls.approveInsuranceProcrestination}`, mastcustcrisisId.toString(), jsonValue)
      .then(value => {
        this.hideOverlay(this.overlay);
        this.submitt.emit();
        this.hide();
