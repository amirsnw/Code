 ...
 * 
 */
@WebServiceClient(name = "elm-service", targetNamespace = "http://tempuri.org/", wsdlLocation = "file:/wsdl/elm-service.wsdl")
    ...
    extends javax.xml.ws.Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/wsdl/elm-service.wsdl");
    ...
    public ElmService(WebServiceFeature... features) {
        super(__getWsdlLocation(), SERVICE_QNAME, features);
    }

    public ElmService(URL wsdlLocation) {
        super(wsdlLocation, SERVICE_QNAME);
    }

    public ElmService(URL wsdlLocation, WebServiceFeature... features) {
        super(wsdlLocation, SERVICE_QNAME, features);
    }

    public ElmService(URL wsdlLocation, QName serviceName) {
        super(wsdlLocation, serviceName);
    }

    public ElmService(URL wsdlLocation, QName serviceName, WebServiceFeature... features) {
