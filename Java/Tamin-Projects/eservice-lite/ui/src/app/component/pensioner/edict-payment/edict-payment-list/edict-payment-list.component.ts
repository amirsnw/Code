...
@Component({
  ...
  templateUrl: './edict-payment-list.component.html',
  styleUrls: ['./edict-payment-list.component.css']
})
export class EdictPaymentListComponent extends TaminPageBaseComponent {
  ...
  refreshData() {
    ...
    this.restService
      .getAll(Urls.PensionerFishRequest, searchParams)
      .then(result => {
  ...
  print() {
    ...
    this._overlay = this.showOverlay();
    this.restService
      .getBlob(Urls.PensionerFishRequestPrint, searchParams)
      .then(result => {
        this.hideOverlay(this._overlay);
  ...
  sendToAnnoncment() {
    ...
    this._overlay = this.showOverlay();
    this.restService
      .getAll(Urls.PensionerFishAnnoncment, searchParams)
      .then(result => {
        this.hideOverlay(this._overlay);
