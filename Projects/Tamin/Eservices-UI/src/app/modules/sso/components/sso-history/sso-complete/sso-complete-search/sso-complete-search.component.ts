...
@Component({
  selector: 'app-sso-complete-search',
  templateUrl: './sso-complete-search.component.html',
  styleUrls: ['./sso-complete-search.component.css']
})

export class SsoCompleteSearchComponent extends TaminPageBaseComponent {
