    ...
    init: function () {
        ...
        Ext.Ajax.request({
            ...
            success: function (response) {
                ...
                me.getViewModel().set('occurRep', data);
    ...
    onOccurReviewEditButton: function () {
        ...
        for (var i = 0; i < partValues.length; i++) {
            tempParts.push({
                ...
                'reqId': !activeRecord.hasReview ? me.getViewModel().get('occurRep').reqId : null
            });
        }
        ...
        var data = {
            ...
            reqId: me.getViewModel().get('occurRep').reqId,
            ...
            risuid: me.getViewModel().get('occurRep').risuid,
            brchCode: me.getViewModel().get('occurRep').brchCode.branchCode,
            rwshid: me.getViewModel().get('occurRep').workshopId
        };
        ...
        if (activeRecord.hasReview) {
            ...
            data.occurRep = me.getViewModel().get('occurRep');
