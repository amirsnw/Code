Ext.define('InsuranceTechnical.tamin.helpers.Persian', {
    requires: ['InsuranceTechnical.tamin.PDate'],
    statics: {
        ...
        gregorianToPersian: function (date) {
            ...
            var tmp = InsuranceTechnical.tamin.PDate.GregorianToPersian(year, month, day);
        ...
        taminDateToGregorian: function (value) {
            ...
            var tmp = InsuranceTechnical.tamin.PDate.PersianToGregorian(y, m, d);
            return new Date(tmp[0], tmp[1] - 1, tmp[2]);
        },
        getTimestamp: function (date) {
            var yyyy = InsuranceTechnical.tamin.PDate.getFullYear(date);
            var mm = InsuranceTechnical.tamin.PDate.getMonth(date);
