Ext.define('InsuranceTechnical.view.main.InsuredPersonPopup', {
    ...
    afterRender: function () {
        ...
        this.up().getViewModel().set('setadi', orgCode === '0000');
        Ext.getCmp('popUpBranchCode').setValue(orgCode)
                    ...
                    items: [
                        {
                            ...
                            listeners: {
                                beforequery: function (queryEvent) {
                                    var me = arguments[0].combo.up('window');
                                    var branchComp = me.items.items[0].items.items[0].items.items[0];
                                    if (branchComp.getValue() === null
                                        || branchComp.getValue() === undefined
                                        || branchComp.getValue() === '') {
                                        return;
                                    }
                                    var val = branchComp.getValue().split('-')[0];
                            ...
                            items: [
                                ...
                                },
                                {
                                    ...
                                    handler: function () {
                                        ...
                                        Ext.Object.each(form.getValues(), function (property, value) {
                                            if (property !== 'branchCode') {
                                                form.getForm().findField(property).reset();
                                            }
                                        });
