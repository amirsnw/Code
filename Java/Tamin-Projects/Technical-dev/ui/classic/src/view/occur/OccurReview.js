                            ...
                            items: [
                                {
                                    ...
                                    name: 'branch',
                                    bind: {
                                        value: '{occurRep.regBrchCode.branchCode} - {occurRep.regBrchCode.branchName}'
                                    }
                                },
                                {
                                    xtype: 'tdisplayfield',
                                    ...
                                    name: 'branch',
                                    bind: {
                                        value: '{occurRep.brchReviewer.branchCode} - {occurRep.brchReviewer.branchName}'
                                    }
                                },
                                {
                                    xtype: 'cellspacer',
