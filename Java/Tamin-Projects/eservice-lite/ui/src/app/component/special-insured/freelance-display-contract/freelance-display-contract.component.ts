...
@Component({
  selector: 'app-freelance-display-contract',
  templateUrl: './freelance-display-contract.component.html',
  styleUrls: ['./freelance-display-contract.component.css']
})
export class FreelanceDisplayContractComponent extends TaminPageBaseComponent {
  ...
  onSearchSubmit() {
    const url = Urls.freelancedisplayDetailContract;
  ...
  clickContractGridItem(param: any) {
    ...
    const url = Urls.freelancedisplayDetailContracttow + `?debit-number=${param[3]}&contract-number=${param[4]}`;
