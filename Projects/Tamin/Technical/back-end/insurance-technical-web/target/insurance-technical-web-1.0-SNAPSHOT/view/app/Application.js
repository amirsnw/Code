Ext.define('InsuranceTechnical.Application', {
    extend: 'Ext.app.Application',
    requires: [
        'InsuranceTechnical.helper.TokenStorage',
        'InsuranceTechnical.tamin.*',
        'InsuranceTechnical.view.*'
    ],
    ...
    launch: function () {
        var me = this;
        var globalAjaxOpsTimeout = 400000;
    ...
    initializeSecurity: function () {
        Ext.Ajax.on('beforerequest', function (conn, options) {
            ...
            options.headers['Authorization'] = 'Bearer ' + InsuranceTechnical.helper.TokenStorage.retrieve();
        });
    ...
    initializeVTypes:function(){
        ...
        Ext.apply(Ext.form.field.VTypes, {
            greaterThenToday: function (value, field) {
                var tmp = InsuranceTechnical.tamin.utils.PersianHelper.getGregorianDate(value);
