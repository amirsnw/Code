...
@Component({
  selector: 'app-special-sucsses-request',
  templateUrl: './special-sucsses-request.component.html',
  styleUrls: ['./special-sucsses-request.component.css']
})

export class SpecialSucssesRequestComponent extends TaminPageBaseComponent {
