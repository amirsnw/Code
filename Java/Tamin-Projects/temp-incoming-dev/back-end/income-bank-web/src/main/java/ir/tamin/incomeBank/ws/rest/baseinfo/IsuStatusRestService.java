...
import ir.tamin.incomeBank.service.baseinfo.IsuStatusService;
...
@RequestScoped
public class IsuStatusRestService {

    @Inject
    IsuStatusService service;
    ...
    @Path("/item-page")
    @RolesAllowed(Roles.PUBLIC_USER)
    public Response getItemPage(@QueryParam(value = "isustatcode") String code, @QueryParam(value = "filter") FilterWrapper filters, @QueryParam(value = "start") Integer start, @QueryParam(value = "limit") Integer limit, @QueryParam(value = "sort") SortWrapper sort, @Context UriInfo ui, @Context SecurityContext sc) {
