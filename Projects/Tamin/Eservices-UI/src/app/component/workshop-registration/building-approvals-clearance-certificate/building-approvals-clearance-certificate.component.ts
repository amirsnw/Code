...
@Component({
  selector: 'app-building-approvals-clearance-certificate',
  templateUrl: './building-approvals-clearance-certificate.component.html',
  styleUrls: ['./building-approvals-clearance-certificate.component.css']
})
export class BuildingApprovalsClearanceCertificateComponent extends TaminPageBaseComponent {

  @ViewChild('workshopGrid') workshoptGrid: TaminDataGridComponent;
  @ViewChild('BuildingApprovalGrid') BuildingApprovalGrid: TaminDataGridComponent;
  ...
  initializePage() {
    ...
    this._initializeBuildingApprovalHeadGrid();
  }
  ...
  private _initializeBuildingApprovalHeadGrid() {
    this.BuildingApprovalGrid.configuration = (new TaminDataGridConfigurationFactory())
      .clearActionColumns()
      .clearSearchParams()
      .clearSortParams()
      .clearVisibleColumns()
  ...
  clickWorkshopGridItem(param: any) {
    ...
    const url = Urls.clearanceCertificateBuildingApproval + '/' + workshopId + '/' + branchCode;
    this.BuildingApprovalGrid.serviceUrl = url;
    this.BuildingApprovalGrid.pagerCurrentPage = 1;
    this.BuildingApprovalGrid.searchParams = this.searchParams;
    this.BuildingApprovalGrid.refreshData();
  }

  onBuildingApprovalGridAction(param: any) {
    var me = this
