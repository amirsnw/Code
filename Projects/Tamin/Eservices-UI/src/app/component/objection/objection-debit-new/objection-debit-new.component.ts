...
@Component({
  selector: 'app-objection-debit-new',
  templateUrl: './objection-debit-new.component.html',
  styleUrls: ['./objection-debit-new.component.css']
})
export class ObjectionDebitNewComponent extends TaminPageBaseComponent {
  theForm: FormGroup;
