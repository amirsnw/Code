...
@NamedQueries({
   @NamedQuery(name = "AgreementCategory.getByCategoryId", query = "select c.activityCode from AgreementActivity c where c.agreementCategoryId=:agreementCategoryId")
})
