import {DataColumnViewType, SearchOperator, SearchParam, TaminDataGridComponent, TaminDataGridConfigurationFactory, TaminFieldAutoCompleteDataGridComponent, TaminPageBaseComponent} from 'tamin-framework';
...
@Component({
  selector: 'app-sso-relation-list',
  templateUrl: './sso-relation-list.component.html',
  styleUrls: ['./sso-relation-list.component.css']
})
export class SsoRelationListComponent extends TaminPageBaseComponent implements OnInit {
  ...
  initializeGrid(params) {
    this.dataGrid.configuration = (new TaminDataGridConfigurationFactory())
      ...
      .clearSortParams()
      .clearVisibleColumns()
      .addUrl(Urls.SSORelationAll + '/' + params.nationalCode + '/' + params.ticketCode)
      .setShowPager(true)
      .setFirstLoad(true)
  ...
  confirmClick(values, valid) {
    ...
    this.restService
      ...
      .then(result => {
        return this.restService.create(Urls.relationDone, {childNationalCode: this.nationalCode});
      }).then(value => {
