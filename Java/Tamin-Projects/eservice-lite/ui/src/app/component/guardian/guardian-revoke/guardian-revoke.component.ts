...
export class GuardianRevokeComponent extends TaminPageBaseComponent {
  ...
  protected initializePage(): void {
    ...
    this.mainForm.get('requestType').valueChanges.subscribe(select => {
      ...
      this.birthDateTemp = momentNs.from(new Date(item.relationWithTamin.personal.dateOfBirth).toString(), 'en').locale('fa').format('YYYY/MM/DD');
      ...
      data.guardianRelationlistList.push(
        {
          ...
          birthDate: momentNs.from(new Date(this.revokeForm.get('birthDate').value).toString(), 'en').locale('fa').format('YYYYMMDD'),
      ...
      data.guardianRelationlistList.push(
        {
          ...
          birthDate: momentNs.from(new Date(this.revokeForm.get('birthDateMother').value).toString(), 'en').locale('fa').format('YYYYMMDD'),
