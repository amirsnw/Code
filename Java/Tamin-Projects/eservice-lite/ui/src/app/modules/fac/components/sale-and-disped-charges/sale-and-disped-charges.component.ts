...
@Component({
  selector: 'app-sale-and-disped-charges',
  templateUrl: './sale-and-disped-charges.component.html',
  styleUrls: ['./sale-and-disped-charges.component.css']
})
export class SaleAndDispedChargesComponent extends TaminPageBaseComponent {
  ...
  private _initializeDataGrid() {
    ...
    this.dataGrid.configuration = (new TaminDataGridConfigurationFactory())
      ...
      .addVisibleColumn({columnName: 'advertisingCost', columnCaption: 'هزینه تبلیغات', columnViewType: 'Label'})
      .addVisibleColumn({columnName: 'marketingCommission', columnCaption: 'بازاریابی / کمیسیون', columnViewType: 'Label'})
      .addVisibleColumn({columnName: 'inventory', columnCaption: 'انبارداری ', columnViewType: 'Label'})
      .addVisibleColumn({columnName: 'packing', columnCaption: 'بسته بندی', columnViewType: 'Label'})
      .addVisibleColumn({columnName: 'advancePayment', columnCaption: 'حق العمل', columnViewType: 'Label'})
      .addVisibleColumn({columnName: 'leaseWarehouse', columnCaption: 'اجاره انبار', columnViewType: 'Label'})
      .addVisibleColumn({columnName: 'keepingGoods', columnCaption: 'نگهداری کالا', columnViewType: 'Label'})
      .addVisibleColumn({columnName: 'carriageFares', columnCaption: 'کرایه حمل', columnViewType: 'Label'})
      .addVisibleColumn({columnName: 'totalSumDisSalCost', columnCaption: 'جمع کل', columnViewType: 'Label'})
   ...
   onNew() {
    debugger;
    this.editMode = '0';
    this.redirectTo('/fac/newSaleAndDispedCharges/' + this.editMode + '/' +  this.requestId);
  }
  onAction(param: any) {
    debugger;
