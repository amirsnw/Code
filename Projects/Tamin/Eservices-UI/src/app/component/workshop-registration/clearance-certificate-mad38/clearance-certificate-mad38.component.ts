...
@Component({
  ...
  templateUrl: './clearance-certificate-mad38.component.html',
  styleUrls: ['./clearance-certificate-mad38.component.css']
})
export class ClearanceCertificateMad38Component extends TaminPageBaseComponent {
  ...
  private _initializeContractGrid() {
    this.contractGrid.configuration = (new TaminDataGridConfigurationFactory())
      ...
      .clearSortParams()
      .clearVisibleColumns()
      .addUrl(Urls.contractByWorkshop)
      .setShowPager(true)
  ...
  clickContractGridItem(param: any) {
    ...
    // const url = Urls.clearanceCertificateMad38Heads + '/0010003891/0010/00100001' ;
