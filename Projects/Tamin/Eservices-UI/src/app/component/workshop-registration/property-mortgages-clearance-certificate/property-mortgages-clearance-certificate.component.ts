...
@Component({
  selector: 'app-property-mortgages-clearance-certificate',
  templateUrl: './property-mortgages-clearance-certificate.component.html',
  styleUrls: ['./property-mortgages-clearance-certificate.component.css']
})
export class PropertyMortgagesClearanceCertificateComponent extends TaminPageBaseComponent {

  @ViewChild('workshopGrid') workshoptGrid: TaminDataGridComponent;
  @ViewChild('PropertyMortgagesGrid') PropertyMortgagesGrid: TaminDataGridComponent;
  ...
  initializePage() {
    ...
    this._initializePropertyMortgagesHeadGrid();
  }
  ...
  private _initializePropertyMortgagesHeadGrid() {
    this.PropertyMortgagesGrid.configuration = (new TaminDataGridConfigurationFactory())
      .clearActionColumns()
      .clearSearchParams()
      .clearSortParams()
      .clearVisibleColumns()
  ...
  clickWorkshopGridItem(param: any) {
    ...
    const url = Urls.clearanceCertificatePropertyMortgages + '/' + workshopId + '/' + branchCode;
    this.PropertyMortgagesGrid.serviceUrl = url;
    this.PropertyMortgagesGrid.pagerCurrentPage = 1;
    this.PropertyMortgagesGrid.searchParams = this.searchParams;
    this.PropertyMortgagesGrid.refreshData();
  }

  onPropertyMortgagesGridAction(param: any) {
    var me = this
