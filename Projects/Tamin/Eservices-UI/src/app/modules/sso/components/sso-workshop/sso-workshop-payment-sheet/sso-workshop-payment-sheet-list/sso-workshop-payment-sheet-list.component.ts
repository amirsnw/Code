...
@Component({
  selector: 'app-sso-workshop-payment-sheet-list',
  templateUrl: './sso-workshop-payment-sheet-list.component.html',
  styleUrls: ['./sso-workshop-payment-sheet-list.component.css']
})
export class SsoWorkshopPaymentSheetListComponent extends TaminPageBaseComponent {
  ...
  loadData(item) {
    ...
    this.paymentSheetsListGrid.serviceUrl = `${Urls.SSO_getPaymentSheets}`;
