...
@Component({
  selector: 'app-freelance-age-and-history-status',
  templateUrl: './freelance-age-and-history-status.component.html',
  styleUrls: ['./freelance-age-and-history-status.component.css']
})

export class FreelanceAgeAndHistoryStatusComponent extends TaminPageBaseComponent {
  viewForm: FormGroup;
