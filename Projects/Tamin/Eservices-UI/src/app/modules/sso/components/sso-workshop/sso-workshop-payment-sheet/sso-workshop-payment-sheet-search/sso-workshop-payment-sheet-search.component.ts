...
@Component({
  selector: 'app-sso-workshop-payment-sheet-search',
  templateUrl: './sso-workshop-payment-sheet-search.component.html',
  styleUrls: ['./sso-workshop-payment-sheet-search.component.css']
})
export class SsoWorkshopPaymentSheetSearchComponent extends TaminPageBaseComponent {
  ...
  private loadServiceDebitReason() {
    this.restService.getAll(Urls.SSO_DebitReason)
      .then(value => {
