...
@Component({
  selector: 'app-insured-status-search',
  templateUrl: './insured-status-search.component.html',
  styleUrls: ['./insured-status-search.component.css']
})
export class InsuredStatusSearchComponent extends TaminPageBaseComponent {
