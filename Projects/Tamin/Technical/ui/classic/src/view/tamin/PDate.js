Ext.define('InsuranceTechnical.tamin.PDate', {
    statics: {
        ...
        PersianToGregorian: function (jy, jm, jd) {
            ...
            for (var i = 0; i < jm; ++i)
                j_day_no += InsuranceTechnical.tamin.PDate.j_days_in_month[i];
            ...
            for (var i = 0; g_day_no >= InsuranceTechnical.tamin.PDate.g_days_in_month[i] + (i == 1 && leap); i++)
                g_day_no -= InsuranceTechnical.tamin.PDate.g_days_in_month[i] + (i == 1 && leap);
            gm = i + 1,
                gd = g_day_no + 1;
        ...
        GregorianToPersian: function (gy, gm, gd) {
            ...
            for (var i = 0; i < gm; ++i)
                g_day_no += InsuranceTechnical.tamin.PDate.g_days_in_month[i];
            ...
            for (var i = 0; i < 11 && j_day_no >= InsuranceTechnical.tamin.PDate.j_days_in_month[i]; ++i) {
                j_day_no -= InsuranceTechnical.tamin.PDate.j_days_in_month[i];
            }
            jm = i + 1,
                jd = j_day_no + 1;
        ...
        setFullYear: function (date, y, m, d) {
            var gd = date.getDate(),
                gm = date.getMonth(),
                gy = date.getFullYear(),
                j = InsuranceTechnical.tamin.PDate.GregorianToPersian(gy, gm + 1, gd);
            ...
            if (d != undefined)
                j[2] = d;
            var g = InsuranceTechnical.tamin.PDate.PersianToGregorian(j[0], j[1], j[2]);
        ...
        toString: function (date) {
            ...
            return InsuranceTechnical.tamin.PDate.getFullYear(date) + "-"
                + pad(InsuranceTechnical.tamin.PDate.getMonth(date) + 1, 2, '0') + "-"
                + pad(InsuranceTechnical.tamin.PDate.getDate(date), 2, '0') + "T"
        ...
        getShortMonthName: function (month) {
            return InsuranceTechnical.tamin.PDate.monthNames[month].substring(0, 3);
        },
        //</locale>
        ...
        getShortDayName: function (day) {
            return InsuranceTechnical.tamin.PDate.dayNames[day].substring(0, 3);
        },
        //</locale>
        ...
        getMonthNumber: function (name) {
            ...
            return InsuranceTechnical.tamin.PDate.monthNumbers[name.substring(0, 1).toUpperCase() + name.substring(1, 3).toLowerCase()];
        },
        //</locale>
         ...
         */
        formatCodes: {
            d: "Ext.String.leftPad(    InsuranceTechnical.tamin.PDate.getDate(this), 2, '0')",
            D: "    InsuranceTechnical.tamin.PDate.getShortDayName(this.getDay())", // get localised short day name
            j: "    InsuranceTechnical.tamin.PDate.getDate(this)",
            l: "    InsuranceTechnical.tamin.PDate.dayNames[this.getDay()]",
            N: "(this.getDay() ? this.getDay() : 7)",
            S: "    InsuranceTechnical.tamin.PDate.getSuffix(this)",
            w: "this.getDay()",
            z: "    InsuranceTechnical.tamin.PDate.getDayOfYear(this)",
            W: "Ext.String.leftPad(    Tamin.PDate.getWeekOfYear(this), 2, '0')",
            F: "    InsuranceTechnical.tamin.PDate.monthNames[    InsuranceTechnical.tamin.PDate.getMonth(this)]",
            m: "Ext.String.leftPad(    InsuranceTechnical.tamin.PDate.getMonth(this) + 1, 2, '0')",
            M: "    InsuranceTechnical.tamin.PDate.getShortMonthName(    InsuranceTechnical.tamin.PDate.getMonth(this))", // get localised short month name
            n: "(    InsuranceTechnical.tamin.PDate.getMonth(this) + 1)",
            t: "    InsuranceTechnical.tamin.PDate.getDaysInMonth(this)",
            L: "(    InsuranceTechnical.tamin.PDate.isLeapYear(this) ? 1 : 0)",
            o: "(    InsuranceTechnical.tamin.PDate.getFullYear(this) + (    InsuranceTechnical.tamin.PDate.getWeekOfYear(this) == 1 &&     InsuranceTechnical.tamin.PDate.getMonth(this) > 0 ? +1 : (    InsuranceTechnical.tamin.PDate.getWeekOfYear(this) >= 52 &&     InsuranceTechnical.tamin.PDate.getMonth(this) < 11 ? -1 : 0)))",
            Y: "Ext.String.leftPad(    InsuranceTechnical.tamin.PDate.getFullYear(this), 4, '0')",
            y: "('' +     InsuranceTechnical.tamin.PDate.getFullYear(this)).substring(2, 4)",
            ...
            O: "    InsuranceTechnical.tamin.PDate.getGMTOffset(this)",
            P: "Ext.{Date.getGMTOffset(this, true)",
            T: "    InsuranceTechnical.tamin.PDate.getTimezone(this)",
        ...
        createParser: (function () {
            var code = [
                ...
                "def =     InsuranceTechnical.tamin.PDate.defaults,",
                "results = String(input).match(    InsuranceTechnical.tamin.PDate.parseRegexes[{0}]);", // either null, or an array of matched strings
                ...
                "dt =     InsuranceTechnical.tamin.PDate.clearTime(new Date);",

                // date calculations (note: these calculations create a dependency on Ext.Number.from())
                "y = Ext.Number.from(y, Ext.Number.from(def.y,     InsuranceTechnical.tamin.PDate.getFullYear(dt)));",
                "m = Ext.Number.from(m, Ext.Number.from(def.m - 1,     InsuranceTechnical.tamin.PDate.getMonth(dt)));",
                "d = Ext.Number.from(d, Ext.Number.from(def.d,     InsuranceTechnical.tamin.PDate.getDate(dt)));",
                ...
                "gm=    InsuranceTechnical.tamin.PDate.PersianToGregorian(y, m+1, d);y=gm[0];m=gm[1]-1;d=gm[2];",
        ...
        parseCodes: {
            ...
            F: function () {
                return {
                    g: 1,
                    c: "m = parseInt(    InsuranceTechnical.tamin.PDate.getMonthNumber(results[{0}]), 10);\n", // get localised month number
            ...
            y: {
                ...
                + "y = ty >     InsuranceTechnical.tamin.PDate.y2kYear ? 1300 + ty : 1400 + ty;\n", // 2-digit year
                s: "(\\d{1,2})"
            },
            /*
        ...
        getDayOfYear: function (date) {
            var num = 0,
                d = InsuranceTechnical.tamin.PDate.clone(date),
                m = InsuranceTechnical.tamin.PDate.getMonth(date),
                i;

            for (i = 0, utilPDate.setDate(d, 1), utilPDate.setMonth(d, 0); i < m; utilPDate.setMonth(d, ++i)) {
                num += utilPDate.getDaysInMonth(d);
            }
            return num + InsuranceTechnical.tamin.PDate.getDate(date) - 1;
        },
        /**
        ...
        getWeekOfYear: function (date) {
            var days = InsuranceTechnical.tamin.PDate.getDayOfYear(date);
        ...
        isLeapYear: function (date) {
            var year = InsuranceTechnical.tamin.PDate.getFullYear(date),
                mod = year % 33;
         ...
         * <pre><code>
         ...
         firstDay =     InsuranceTechnical.tamin.PDate.getFirstDayOfMonth(dt);
         console.log(    InsuranceTechnical.tamin.PDate.dayNames[firstDay]); //output: 'Monday'
         * </code></pre>
         * @param {Date} date The date
        ...
        getFirstDateOfMonth: function (date) {
            var c = InsuranceTechnical.tamin.PDate.clone(date);
            InsuranceTechnical.tamin.PDate.setDate(c, 1);
            return c;
        },
        /**
        ...
        getLastDateOfMonth: function (date) {
            var c = InsuranceTechnical.tamin.PDate.clone(date);
            InsuranceTechnical.tamin.PDate.setDate(c, utilPDate.getDaysInMonth(date));
            return c;
        },
        /**
        ...
        getDaysInMonth: function (date) {
            var m = InsuranceTechnical.tamin.PDate.getMonth(date);

            return m == 11 && InsuranceTechnical.tamin.PDate.isLeapYear(date) ? 30 : InsuranceTechnical.tamin.PDate.j_days_in_month[m];
        },
        /**
        ...
        add: function (date, interval, value) {
            // 
            var d = InsuranceTechnical.tamin.PDate.clone(date),
                day;
            if (!interval || value === 0) {
                return d;
            }
            ...
            switch (interval.toLowerCase()) {
                ...
                case Ext.Date.DAY:
                    ...
                    break;
                case Ext.Date.MONTH:
                    day = InsuranceTechnical.tamin.PDate.getDate(d);
                    if (day > 29) {
                        day = Math.min(day, InsuranceTechnical.tamin.PDate.getLastDateOfMonth(InsuranceTechnical.tamin.PDate.add(InsuranceTechnical.tamin.PDate.getFirstDateOfMonth(d), Ext.Date.MONTH, value)).getDate());
                    }
                    InsuranceTechnical.tamin.PDate.setDate(d, day);
                    InsuranceTechnical.tamin.PDate.setMonth(d, InsuranceTechnical.tamin.PDate.getMonth(d) + value);
                    break;
                case Ext.Date.YEAR:
                    day = InsuranceTechnical.tamin.PDate.getDate(d);
                    if (day > 29) {
                        day = Math.min(day, InsuranceTechnical.tamin.PDate.getLastDateOfMonth(InsuranceTechnical.tamin.PDate.add(InsuranceTechnical.tamin.PDate.getFirstDateOfMonth(d), Ext.Date.YEAR, value)).getDate());
                    }
                    InsuranceTechnical.tamin.PDate.setDate(d, day);
                    InsuranceTechnical.tamin.PDate.setFullYear(d, InsuranceTechnical.tamin.PDate.getFullYear(d) + value);
                    break;
            }
            return d;
        },
...
var utilPDate = InsuranceTechnical.tamin.PDate;
function xf(format) {
