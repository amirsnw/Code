...
export class StageThreeFormGeneratorService {
  ...
  downloadForm4PdfMobile(requestNumber: string, commNationalCode: string, commBirthDate: Date, mainDoctorFirstName: string,
                         mainDoctorLastName: string, mainDoctorSpeciality: string, demandInfoId: number, formType: string,
                         component: any) {
    ...
    const searchFormType = new SearchParam();
    searchFormType.property = 'committeeFormType';
    searchFormType.operator = SearchOperator.EQUAL;
    searchFormType.value = formType;
    searchParams.push(searchFormType);
