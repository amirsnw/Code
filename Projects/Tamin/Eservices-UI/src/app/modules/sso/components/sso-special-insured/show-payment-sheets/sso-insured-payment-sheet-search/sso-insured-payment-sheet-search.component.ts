...
@Component({
  selector: 'app-sso-insured-payment-sheet-search',
  templateUrl: './sso-insured-payment-sheet-search.component.html',
  styleUrls: ['./sso-insured-payment-sheet-search.component.css']
})
export class SsoInsuredPaymentSheetSearchComponent extends TaminPageBaseComponent {
